...
[hi](https://github.com/sila/consensus-specs/blob/6c2b46ae3248760e0f6e52d61077d8b31e43ad1d/specs/sip4844/validator.md#compute_aggregated_poly_and_commitment)
"#;
    ...
    let reports = Linter::<Text<String>>::default()
        ...
        .deny(
            ...
            RelativeLinks {
                exceptions: vec![
                    "^https://(www\\.)?github\\.com/sila/consensus-specs/blob/[a-f0-9]{40}/.+$",
                ],
            },
        )
...
<img src="//sips.sila.org/assets/sip-712/sil_sign.png">
"#;
    ...
    assert_eq!(
        ...
        r#"error[markdown-rel]: non-relative link or image
  |
5 | <img src="//sips.sila.org/assets/sip-712/sil_sign.png">
  | ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ used here
  |
  = help: use `../assets/sip-712/sil_sign.png` instead
"#
    );
}
...
<img src="//srcs.sila.org/assets/src-712/sil_sign.png">
"#;
    ...
    assert_eq!(
        ...
        r#"error[markdown-rel]: non-relative link or image
  |
5 | <img src="//srcs.sila.org/assets/src-712/sil_sign.png">
  | ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ used here
  |
  = help: use `../assets/src-712/sil_sign.png` instead
"#
    );
}
...
<img src="https://sips.sila.org/assets/sip-712/sil_sign.png">!
"#;
    ...
    assert_eq!(
        ...
        r#"error[markdown-rel]: non-relative link or image
  |
5 | <img src="https://sips.sila.org/assets/sip-712/sil_sign.png">!
  | ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ used here
  |
  = help: use `../assets/sip-712/sil_sign.png` instead
"#
...
<img src="https://srcs.sila.org/assets/src-712/sil_sign.png">
"#;
    ...
    assert_eq!(
        ...
        r#"error[markdown-rel]: non-relative link or image
  |
5 | <img src="https://srcs.sila.org/assets/src-712/sil_sign.png">
  | ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ used here
  |
  = help: use `../assets/src-712/sil_sign.png` instead
"#
