...
use sipw_lint::config::DefaultOptions;
use sipw_snippets::Message;

use clap::{Parser, ValueEnum};

use sipw_lint::reporters::{AdditionalHelp, Count, Json, Reporter, Text};
...
impl Reporter for EitherReporter {
    fn report(&self, snippet: Message<'_>) -> Result<(), sipw_lint::reporters::Error> {
        match self {
